...
public class LoanRepayment {
    ...
    public Double getRemainingOutstanding() { return remainingOutstanding; }
    public void setRemainingOutstanding(Double remainingOutstanding) { this.remainingOutstanding = remainingOutstanding; }
}
