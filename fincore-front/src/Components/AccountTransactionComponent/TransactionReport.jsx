...
const TransactionReport = () => {
    ...
    const totalLoanAmount = useMemo(() => {
        return filteredTransactions
            .filter((t) => String(t.transactionType || "") === "Loan Disbursement")
            .reduce((sum, t) => sum + Number(t.transactionAmount || 0), 0);
    }, [filteredTransactions]);
        ...
        <div style={ts.page}>
            ...
            <div style={ts.statsGrid}>
                ...
                <div style={ts.statCard("#f4dfb7")}>
                 ...
                 { (totalLoanAmount <= 0) ? null :
                <div style={ts.statCard("#d9f1e1")}>
                    <div style={ts.statLabel("#15803d")}>Total Loan Amount</div>
                    <div style={ts.statValue("#15803d")}>₹ {formatAmount(totalLoanAmount)}</div>
                </div>}
            </div>
                            ...
                            <tbody>
                                {filteredTransactions.length === 0 ? (
                                    ...
                                    filteredTransactions.map((transaction, index) => {
                                        ...
                                        const isLoanDisbursement = type === "loan disbursement";
                                        const isCredit = isDeposit || isLoanDisbursement;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td style={ts.td}>
                                                    <span style={ts.typeBadge(isCredit)}>
                                                        {isLoanDisbursement
                                                            ? "Loan Disbursement"
                                                            : isDeposit
                                                                ? "Deposit"
                                                ...
                                                <td style={ts.td}>
                                                    <span style={ts.amountText(isCredit)}>
                                                        {isCredit ? "+" : "-"} ₹{" "}
