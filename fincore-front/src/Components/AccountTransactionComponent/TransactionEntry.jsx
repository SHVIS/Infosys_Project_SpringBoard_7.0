...
import { generateTransactionId, addTransaction } from "../../Services/TransactionService";
...
const TransactionEntry = () => {
    ...
    useEffect(() => {
        ...
        getCustomerByUsername()
            .then((res) => {
                ...
                return getAccountIdsByCustomerIdAndType("Savings");
            })
            .then((res) => {
    ...
    const handleValidation = (e) => {
        ...
        if (!transaction.transactionAmount || Number(transaction.transactionAmount) <= 0) {
            tempErrors.transactionAmount = "Please enter a valid amount greater than ₹0.";
            valid = false;
        }

        if (!customer.customerId) {
            tempErrors.customerId = "Customer information is not available. Please login again.";
            valid = false;
        }
    ...
    const clearAll = () => {
        setTransaction((prev) => ({ ...prev, accountNumber: "", transactionAmount: "" }));
        setErrors({});
        setFlag(0);
    };
                    ...
                    <aside className="fin-sidebar">
                        ...
                        <section className="info-card">
                            ...
                            <div>
                                ...
                                <p>Your transaction is protected by FinCore security controls.</p>
                            </div>
                        </section>
                        ...
                        <section className="info-card help-card">
                            ...
                            <p>Verify your account and transaction amount before continuing.</p>
                        </section>
                    ...
                    <section className="transaction-card">
                                ...
                                <div>
                                    ...
                                    <p>
                                        {isDeposit
                                            ...
                                            : "Insufficient balance. Minimum balance of ₹5000 must be maintained."}
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        <form onSubmit={handleValidation} className="transaction-form">
                            ...
                            <div className="form-actions">
                                <button type="button" className="reset-button" onClick={clearAll}>
                                    Reset
                                </button>
                                <button
                                    type="submit"
                                    className="primary-button"
                                    disabled={loading || !customer.customerId || idList.length === 0}
                                >
