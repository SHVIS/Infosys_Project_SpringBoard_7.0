...
const AccountEntry = () => {
  ...
  const loadDetails = async () => {
    ...
    setAccount((prev) => ({...prev,accountNumber: Number(accRes.data),
    }));
...
const onChangeHandler = (e) => {
  ...
  const handleValidation = (e) => {
    ...
    if (
      account.balance === "" ||
      Number(account.balance) < 1||
      Number(account.balance) > 100000
    ) {
      temp.balance = "Balance must be between 1 and 100000";
    }
    if (!account.customerId) 
        temp.customerId = "Customer is required";
    
    if (!account.accountType) 
        temp.accountType = "Account Type is required";
    
    if (!openDate) 
      temp.accountOpenDate = "Select account opening date";
...
const saveAccount = () => {
    ...
    addAccount(newAccount).then(() =>{ 
        ...
        .catch(error => {console.log(error);if(error.res) alert("Error : "+error.res.data); else alert("Unable to Save Accout") });
};
            ...
            <header style={as_.entryHeader}>
                ...
                <div style={as_.entryUserArea}>
                    ...
                    <div style={as_.entryUserRow}>
                        ...
                        <div>
                            <div style={as_.entryUserName}>Balkishan</div>
                    ...
                    <div style={as_.entryFormCard}>
                        ...
                        <form onSubmit={handleValidation}>
                            ...
                            <div style={as_.entryFieldGroup}>
                                ...
                                <input type="text" value={account.accountNumber} readOnly style={as_.entryReadOnlyInput} />
